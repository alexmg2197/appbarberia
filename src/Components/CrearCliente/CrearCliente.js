                ...
                <div className="card card-primary mt-3">
                    ...
                    <Formik
                        ...
                        validate={values => {
                            ...
                            if (!values.codigo) errors.codigo = 'El codigo es indespensable'
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="card-body row">
                                        ...
                                        <div className="form-group col-6">
                                            ...
                                            <input type="text" className={`form-control ${errors.codigo && 'mark_wrong'}`} id="codigo" onChange={(val) => { setFieldValue('codigo', val.target.value) }} value={values.codigo} />
                                            <p className="eti-err">{errors.codigo}</p>
                                        </div>
                                        <div className="form-group col-6">
